...
Al final si utilize algo de codigo de IA para el checkbox y la logica que hace que los circulos solo se muevan en un eje.
El fin de este proyecto es demostrar gráficamente el teorema.
Este proyecto no hace buen uso de React y  contiene malas practicas.
